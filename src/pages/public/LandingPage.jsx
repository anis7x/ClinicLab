            ...
            <section className="relative min-h-[90vh] flex items-center justify-center pt-20">
                ...
                <div className="container relative z-10 px-4 md:px-8 text-center">
                    ...
                    >
                        ...
                        >
                            <div className="flex-1 flex items-center px-6 bg-white/50 rounded-full h-24 md:h-20 shadow-inner transition-colors hover:bg-white/70 group relative z-50">
                            ...
                            <div className="flex-1 flex items-center px-6 bg-white/50 rounded-full h-24 md:h-20 shadow-inner transition-colors hover:bg-white/70 group">
